    ...
    BEGIN
        RETURN QUERY
            select
				...
				ihi.title as title,
                to_char((li.loan_date::timestamp AT TIME ZONE 'UTC' AT TIME ZONE 'Australia/Canberra'), 'DD-MM-YYYY HH:MI am') as loan_date,
				to_char((li.loan_return_date::timestamp AT TIME ZONE 'UTC' AT TIME ZONE 'Australia/Canberra'), 'DD-MM-YYYY HH:MI am') as loan_return_date,
